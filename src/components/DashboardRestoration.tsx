...
import { Order, RestorationStage } from '../types';
...
export default function DashboardRestoration({ orders, onUpdateOrder }: DashboardRestorationProps) {
      ...
      <div className="bg-stone-900 text-stone-100 p-6 rounded-3xl border border-stone-850 shadow-xl flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <div className="flex items-center gap-3 mt-1">
            <h1 className="text-xl sm:text-2xl font-serif">Ananya Sen (Digital Colorist)</h1>
            <span className="px-2.5 py-0.5 bg-amber-500/20 text-amber-300 text-[10px] rounded-full border border-amber-500/30">Jaipur Lab Principal</span>
          </div>
        </div>
